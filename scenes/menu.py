...
class MenuScene(BaseScene):
    def __init__(self):
        ...
        self.exit_button = Button(Settings.WIDTH // 2 - 100, Settings.HEIGHT // 2+100, 250, 80, "Exit")
        self.records_button = Button(Settings.WIDTH // 2 - 100, Settings.HEIGHT // 2, 250, 80, "Records")
    ...
    def additional_process_event(self):
        ...
        if self.records_button.check_click():
            pass
